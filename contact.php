		...
		<form class="form-horizontal submit-form login-form" action="#" method="post" id="contact_form">
		    <ul>
		        ...
		        <div class="form-group">
		        	<label for="name" class="col-sm-2">E-mail *</label>
					<div class="col-sm-9"><input requiered type="email" class="form-control" id="name" placeholder="Votre e-mail" required/></div>
				</div>
		      	<div class="form-group">
		        	<label for="country" class="col-sm-2">Sujet *</label>
					<div class="col-sm-9">
						<select id="country" class="form-control" requiered>
		        ...
		        <div class="form-group">
		        	<label for="product-des" class="col-sm-2">Votre message</label>
					<div class="col-sm-9">
						<textarea class="form-control" rows="6" id="product-des" placeholder="Message" requiered></textarea>
					</div>
				</div>
		       </ul>
