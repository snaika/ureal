	...
	<div class="section">
		<div class="col-md-3">
			<ul class="nav nav-pills nav-stacked">
				<li role="presentation" class="active panel-btn" data-check="tab1"><a href="#">Description</a></li>
				<li role="presentation" class="panel-btn" data-check="tab2"><a href="#">Ses produits</a></li>
